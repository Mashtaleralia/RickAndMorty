...
final class RMLocationDetailViewViewModel {
    ...
    private func createCellViewModels() {
        ...
        if let createdDate = RMLocationDetailViewViewModel.dateFormatter.date(from: location.created) {
            createdString = RMLocationDetailViewViewModel.shortDateFormatter.string(from: createdDate)
        }
        cellViewModels = [
